...
public class Main {
    ...
    private static void testPositionService(ConnectionPool pool) {
    ...
    private static void testCabinetService(ConnectionPool pool) {
    ...
    private static void testAppointmentTypeService(ConnectionPool pool) {
    ...
    private static void testPatientService(ConnectionPool pool) {
    ...
    private static void testEmployeeService(ConnectionPool pool) {
    ...
    private static void testAppointmentService(ConnectionPool pool) {
    ...
    private static void testPrescriptionService(ConnectionPool pool) {
    ...
    private static void printRowDelimiter() {
        System.out.println("\n" + "-".repeat(120) + "\n");
    }
}